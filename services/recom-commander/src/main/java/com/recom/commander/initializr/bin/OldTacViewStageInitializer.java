//package com.recom.commander.initializr.bin;
//
...
//public class OldTacViewStageInitializer {
//
//    @NonNull
...
//        event.logStageInitializationWithMessage(log, OldTacViewStageInitializer.class, "Starting TacView");
