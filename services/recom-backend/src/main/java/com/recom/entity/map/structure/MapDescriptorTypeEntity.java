...
public class MapDescriptorTypeEntity implements Persistable<Long>, Serializable {
    ...
    @Builder.Default
    @OneToMany(mappedBy = "mapDescriptorType", fetch = FetchType.LAZY, cascade = CascadeType.ALL, orphanRemoval = true)
    ...
    @Override
    public int hashCode() {
        return MapDescriptorTypeEntity.class.hashCode();
    }
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            final MapDescriptorTypeEntity other = (MapDescriptorTypeEntity) obj;
            if (getId() == null) {
                return false;
