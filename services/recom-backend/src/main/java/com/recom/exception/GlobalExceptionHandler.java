...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ServerMessageDto> handleConfigurationNotReadableException(@NonNull final ConfigurationNotReadableException exception) {
        final String message = String.format("There is an issue with a com.recom.configuration entry in the database! ConfigurationNotReadableException: %s", exception.getMessage());
